    ...
    <>
      <ImageSectionStyled>
        ...
        <div className="right-content">
          ...
          <p className="paragraph">
            I am interested in working as a programmer. And what I'm interested
            in is Computer Programming, Web/App Developer, Devops
          </p>
          <p>
      ...
      <div style={{ display: "flex", justifyContent: "flex-end" }}>
        ...
        <PrimaryButton
          title={"Download CV"}
          onClick={() => {
            window.open(`../html/CV Phattanothai Pukham.pdf`, "_blank");
          }}
          style={{
            marginRight: "5px",
            marginBottom: "5px",
