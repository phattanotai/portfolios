        ...
        <InformationStyled>
          <div className="left-content">
            <p className="paragraph">
              ...
              ชั้นประถมศึกษาที่โรงเรียนบ้านสันมะแฟน
        ...
        <InformationStyled>
          ...
          <div className="right-content">
            <p className="paragraph">
              ...
              จึงได้ย้ายไปศึกษาต่อเปรียญธรรม ประโยค 4 ต่อที่วัดจองคำ
              จังหวัดลำปาง
        ...
        <InformationStyled>
          ...
          <div className="right-content">
            <p className="paragraph">
              ...
              ได้เห็นถึงความสำคัญของเทคโนโลยีคอมพิวเตอร์ จึงได้เอาวุฒิเปรียญธรรม
              6 ไปสอบเทียบเพื่อเข้าศึกษาต่อที่มหาวิทยาลัยราชภัฏสวนสุนันทา
        ...
        <InformationStyled>
          ...
          <div className="right-content">
            ...
            <p className="paragraph">
              ...
              ก็ได้หางานทำที่จังหวัดเชียงราย ก็ได้มีโอกาศได้เข้าทำงานที่บริษัท
              gps tracker แห่งหนึ่งในจังหวัดเชียงราย ในตำแหน่ง programmer
